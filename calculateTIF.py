...
def load_data(data_source):
    ...
    attributes = data['Attributes'] if ('Attributes' in data) else data['X']
    # classes = data['Class']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='cora', choices=['citation', 'citeseer', 'cora', 'dblp', 'pubmed', 'dblp', 'books', 'reddit'])
    args = parser.parse_args()
    data_source = args.dataset
    # adj, features, labels = load_data(data_source)
    adj, features, labels = load_real_data(data_source)
    ...
    print(">> Motif Done...")
    scipy.io.savemat("dataset_with_tif/{}.mat".format(data_source + '_tif'), {'Network': adj, 'Label': labels, 'Attributes': features, 'Motif': motif_feature})
